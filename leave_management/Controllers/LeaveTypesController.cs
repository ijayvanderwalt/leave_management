...
namespace leave_management.Controllers
{
    ...
    public class LeaveTypesController : Controller
    {
        ...
        private readonly ILeaveTypeRepository _repo; //Private uses underscore(naming convention)
        ...
        {
            if (!_repo.isExists(id)) //Checking Worst Case First
            {
                return NotFound();
            }
            var leavetype = _repo.FindById(id);
        ...
        // GET: LeaveTypesContoller/Delete/5
